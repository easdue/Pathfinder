...
public class SVG
{
   ...
   {
	   renderToCanvas(canvas, viewPort, null);
   }
   
   public void renderToCanvas(Canvas canvas, RectF viewPort, String layer) {
	   Box svgViewPort;
	   ...
	   renderer.renderDocument(this, null, null, true, layer);
   }
